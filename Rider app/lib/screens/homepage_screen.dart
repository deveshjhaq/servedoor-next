...
class _HomepageScreenState extends State<HomepageScreen> {
  ...
  Widget build(BuildContext context) {
    var list = Provider.of<Order>(context).OrderItems;
    return isloading
        ? Scaffold(
            body: SizedBox(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        ((list[index].deliverylocation?.length ?? 0) > 2 &&
                                          ...
                                          : Text(
                                              'Location: '
                                                '${(list[index].deliverylocation?.length ?? 0) > 2 ? list[index].deliverylocation![2].toString().substring(0, list[index].deliverylocation![2].toString().length > 250 ? 250 : list[index].deliverylocation![2].toString().length) : ''}',
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .subtitle1
                                                  ?.copyWith(
